...
# 		./out/binary_helper.out "$DIR_DB"/indoor_scans/comp_7/           "$DIR_INDEX"/indoor_scans_3nn/comp_7/comp_7."$r"."$a".grid
# 	done
# done
...
# 		./out/binary_helper.out "$DIR_DB"/indoor_scans/comp_6/           "$DIR_INDEX"/indoor_scans_3nn/comp_6/comp_6."$r"."$a".grid
# 	done
# done
...
# for r in 200 250 #030 060 090 120 150 180 210 240 270 300 400 500 600 700 800 900 1000
# do
...
# 		./out/binary_helper.out "$DIR_DB"/indoor_scans/comp_5/           "$DIR_INDEX"/indoor_scans_3nn/comp_5/comp_5."$r"."$a".grid
# 	done
# done
...
do
	for a in 015
	do
		./out/grid_3nn.out      "$DIR_DB"/indoor_scans/comp_1/ "$r" "$a" "$DIR_INDEX"/indoor_scans_3nn/comp_1/comp_1."$r"."$a".grid -show_prog_bar
		./out/index3.out        "$DIR_DB"/indoor_scans/comp_1/           "$DIR_INDEX"/indoor_scans_3nn/comp_1/comp_1."$r"."$a".grid -show_prog_bar
		./out/binary_helper.out "$DIR_DB"/indoor_scans/comp_1/           "$DIR_INDEX"/indoor_scans_3nn/comp_1/comp_1."$r"."$a".grid
	done
done
