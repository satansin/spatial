...
# ./out/anal_diam.out "$DIR_QUERY"/indoor_scans_pro_noise/comp_5/q_02.0.ply -single
# ./out/anal_diam.out "$DIR_QUERY"/indoor_scans_pro_noise/comp_5/q_05.0.ply -single
# ./out/anal_diam.out "$DIR_QUERY"/indoor_scans_pro_noise/comp_5/q_08.0.ply -single
# ./out/anal_diam.out "$DIR_QUERY"/indoor_scans_pro_noise/comp_5/q_07.0.ply -single

# ./out/anal_diam.out "$DIR_OBJ_DB"/origin/05842.ply -single
# ./out/anal_diam.out "$DIR_OBJ_DB"/origin/06284.ply -single
# ./out/anal_diam.out "$DIR_OBJ_DB"/origin/00942.ply -single
# ./out/anal_diam.out "$DIR_OBJ_DB"/origin/06274.ply -single
# ./out/anal_diam.out "$DIR_OBJ_DB"/origin/08719.ply -single